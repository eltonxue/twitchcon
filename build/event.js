...
var _reactChromeRedux = __webpack_require__(63);
...
exports.FETCH_FAVORITES = undefined;
...
function fetchFavorites(username) {
  ...
  try {
    var channelsUrl = 'https://api.twitch.tv/kraken/users/' + username + '/follows/channels';
  ...
  try {
    ...
    return await (0, _axios2.default)({
      ...
      for (var i = 0; i < followCount; i++) {
        ...
        var live = await (0, _axios2.default)({
          method: 'get',
        ...
        var streamThumbnail = await (0, _axios2.default)({
          method: 'get',
          url: liveUrl + streamer,
          headers: { 'client-id': clientId }
...
var _reducer_favorites = __webpack_require__(52);

var _reducer_favorites2 = _interopRequireDefault(_reducer_favorites);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = (0, _redux.combineReducers)({
  favorites: _reducer_favorites2.default
});
...
var _wrapStore = __webpack_require__(65);

var _wrapStore2 = _interopRequireDefault(_wrapStore);

var _alias = __webpack_require__(62);
...
var _assignIn = __webpack_require__(93);
...
var baseSetToString = __webpack_require__(74),
